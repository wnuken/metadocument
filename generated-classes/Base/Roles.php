...
*/
abstract class Roles implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\RolesTableMap';
    ...
    /**
     * Initializes internal state of Base\Roles object.
     */
    ...
    /**
     * Compares this with another <code>Roles</code> instance.  If
     * <code>obj</code> is an instance of <code>Roles</code>, delegates to
     * <code>equals(Roles)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Roles The current object, for fluid interface
     */
     ...
     * @return $this|\Roles The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RolesTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[RolesTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[RolesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RolesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RolesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = RolesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Roles'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRolesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRolesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RolesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(RolesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(RolesTableMap::COL_DESCRIPTION)) {
    ...
    {
        $pos = RolesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Roles'][$this->hashCode()] = true;
        $keys = RolesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_ID)) {
            $criteria->add(RolesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RolesTableMap::COL_NAME)) {
            $criteria->add(RolesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(RolesTableMap::COL_DESCRIPTION)) {
            $criteria->add(RolesTableMap::COL_DESCRIPTION, $this->description);
        }
    ...
    {
        $criteria = ChildRolesQuery::create();
        $criteria->add(RolesTableMap::COL_ID, $this->id);
    ...
    public function setAdminUsers(Collection $adminUsers, ConnectionInterface $con = null)
    {
        ...
        foreach ($adminUsersToDelete as $adminUserRemoved) {
            $adminUserRemoved->setRoles(null);
        }
    ...
    {
        return (string) $this->exportTo(RolesTableMap::DEFAULT_STRING_FORMAT);
    }
