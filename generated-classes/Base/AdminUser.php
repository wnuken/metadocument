...
abstract class AdminUser implements ActiveRecordInterface
{
    ...
    /**
     * The value for the g_folder field.
     * @var        string
     */
    protected $g_folder;
    ...
    /**
     * Get the [g_folder] column value.
     *
     * @return string
     */
    public function getGfolder()
    {
        return $this->g_folder;
    }
    ...
    /**
     * Set the value of [g_folder] column.
     *
     * @param string $v new value
     * @return $this|\AdminUser The current object (for fluent API support)
     */
    public function setGfolder($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->g_folder !== $v) {
            $this->g_folder = $v;
            $this->modifiedColumns[AdminUserTableMap::COL_G_FOLDER] = true;
        }
    ...
    public function setRol($v)
    {
        ...
        if ($this->id_rol !== $v) {
            $this->id_rol = $v;
            $this->modifiedColumns[AdminUserTableMap::COL_ID_ROL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AdminUserTableMap::translateFieldName('Gfolder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->g_folder = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AdminUserTableMap::translateFieldName('Rol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_rol = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = AdminUserTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminUserTableMap::COL_G_FOLDER)) {
            $modifiedColumns[':p' . $index++]  = 'g_folder';
        }
        if ($this->isColumnModified(AdminUserTableMap::COL_ID_ROL)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'password':
                        ...
                        break;
                    case 'g_folder':
                        $stmt->bindValue($identifier, $this->g_folder, PDO::PARAM_STR);
                        break;
                    case 'id_rol':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminUserTableMap::COL_G_FOLDER)) {
            $criteria->add(AdminUserTableMap::COL_G_FOLDER, $this->g_folder);
        }
        if ($this->isColumnModified(AdminUserTableMap::COL_ID_ROL)) {
            $criteria->add(AdminUserTableMap::COL_ID_ROL, $this->id_rol);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setGfolder($this->getGfolder());
