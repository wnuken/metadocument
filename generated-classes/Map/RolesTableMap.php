...
class RolesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.RolesTableMap';
     ...
     */
    const OM_CLASS = '\\Roles';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Roles';
     ...
     */
    const COL_ROL_NAME = 'roles.rol_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'RolName', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'rolName', 'description', ),
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID, RolesTableMap::COL_ROL_NAME, RolesTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'rol_name', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'RolName' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'rolName' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID => 0, RolesTableMap::COL_ROL_NAME => 1, RolesTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'rol_name' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('rol_name', 'RolName', 'VARCHAR', false, 50, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RolesTableMap::COL_ID);
            $criteria->addSelectColumn(RolesTableMap::COL_ROL_NAME);
            $criteria->addSelectColumn(RolesTableMap::COL_DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Roles) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(RolesTableMap::DATABASE_NAME);
            $criteria->add(RolesTableMap::COL_ID, (array) $values, Criteria::IN);
        }
