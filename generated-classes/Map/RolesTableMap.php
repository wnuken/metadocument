...
class RolesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID, RolesTableMap::COL_NAME, RolesTableMap::COL_DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_ID => 0, RolesTableMap::COL_NAME => 1, RolesTableMap::COL_DESCRIPTION => 2, ),
    ...
    {
        $this->addRelation('AdminUser', '\\AdminUser', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':rol_id',
    1 => ':id',
  ),
), null, null, 'AdminUsers', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RolesTableMap::COL_NAME);
