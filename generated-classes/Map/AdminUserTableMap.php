...
class AdminUserTableMap extends TableMap
{
    ...
    /**
     * the column name for the g_folder field
     */
    const COL_G_FOLDER = 'admin_user.g_folder';

    /**
     * the column name for the id_rol field
     */
    const COL_ID_ROL = 'admin_user.id_rol';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'User', 'Password', 'Gfolder', 'Rol', ),
        self::TYPE_CAMELNAME     => array('id', 'user', 'password', 'gfolder', 'rol', ),
        self::TYPE_COLNAME       => array(AdminUserTableMap::COL_ID, AdminUserTableMap::COL_USER, AdminUserTableMap::COL_PASSWORD, AdminUserTableMap::COL_G_FOLDER, AdminUserTableMap::COL_ID_ROL, ),
        self::TYPE_FIELDNAME     => array('id', 'user', 'password', 'g_folder', 'id_rol', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'User' => 1, 'Password' => 2, 'Gfolder' => 3, 'Rol' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'user' => 1, 'password' => 2, 'gfolder' => 3, 'rol' => 4, ),
        self::TYPE_COLNAME       => array(AdminUserTableMap::COL_ID => 0, AdminUserTableMap::COL_USER => 1, AdminUserTableMap::COL_PASSWORD => 2, AdminUserTableMap::COL_G_FOLDER => 3, AdminUserTableMap::COL_ID_ROL => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'user' => 1, 'password' => 2, 'g_folder' => 3, 'id_rol' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('g_folder', 'Gfolder', 'VARCHAR', false, 256, null);
        $this->addColumn('id_rol', 'Rol', 'INTEGER', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminUserTableMap::COL_G_FOLDER);
            $criteria->addSelectColumn(AdminUserTableMap::COL_ID_ROL);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.user');
            $criteria->addSelectColumn($alias . '.password');
            $criteria->addSelectColumn($alias . '.g_folder');
