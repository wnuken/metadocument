<div role="navigation" class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <div class="btn-group btn-group-xs visible-xs" style="height: 18px; position:fixed;z-index:10; top: 2px;
left: 2px;" role="group" aria-label="...">
                        ...
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalAddFolder">
                                ...
                                <i class="glyphicon glyphicon-indent-left"></i> </button>
                                 <button type="button" class="btn btn-danger" onclick="AvanceSearhgetForm()" data-toggle="modal" data-target="#modalAvanceSearh"><i class="glyphicon glyphicon-random"></i> </button>
                        </div></div>
